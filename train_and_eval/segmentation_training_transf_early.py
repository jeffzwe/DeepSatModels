...
def train_and_evaluate(net, dataloaders, config, device, lin_cls=False):
    ...
    # if not early_classification:
        # raise ValueError("This script requires early_classification to be enabled in the config file. Please set early_classification=True in the SOLVER section of your config.")
